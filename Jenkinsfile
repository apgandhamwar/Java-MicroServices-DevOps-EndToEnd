...
stage('Test') {
     ...
     stage('Artifact Versioning') {
            steps {
                ...
                sh 'git remote add origin https://apgandhamwar@gmail.com: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@github.com/apgandhamwar/Java-MicroServices-DevOps-EndToEnd.git'
